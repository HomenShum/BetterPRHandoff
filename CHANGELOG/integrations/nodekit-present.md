...
## 2026-07-19 — Claim the presentation receipt contract

Declare `betterprhandoff.nodekit-present-receipt/v1` as a canonical protocol
owned by BetterPRHandoff so NodeKit can consume the emitted proof without an
undeclared ownership gap. Runtime transformation behavior is unchanged.

**Commit**: `6d2b7ff`. **Author**: Codex.

**Touches**: `nodekit.yaml`
