...
Three differentiating chat affordances landed via [PR #249](https://github.com/HomenShum/NodeBenchAI/pull/249) (`54600a93`):
...
Three Sprint 3 affordances via [PR #248](https://github.com/HomenShum/NodeBenchAI/pull/248) (`17a9e761`):
...
Two Sprint 2 affordances via [PR #247](https://github.com/HomenShum/NodeBenchAI/pull/247) (`b2254507`):
...
First two enhancements from [docs/architecture/REDESIGN_CHAT_ENHANCEMENTS.md](https://github.com/HomenShum/NodeBenchAI/blob/main/docs/architecture/REDESIGN_CHAT_ENHANCEMENTS.md), via [PR #246](https://github.com/HomenShum/NodeBenchAI/pull/246) (`ee5b0341`):
